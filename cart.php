        ...
        <div class="container">
          ...
          ?>
           <tr>
                            ...
                            <td class="cart_total">
                                <p class="cart_total_price"><?php echo '$' . number_format($precio, 2); ?></p>
                            </td>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="total_area">
                        <ul>
                            <li>Sub Total del carrito<span><?php echo '$' . number_format(59, 2); ?></span></li>
                            <li>Impuestos <span><?php echo '$' . number_format(2, 2); ?></span></li>
                            <li>Precio de envio<span>Gratis</span></li>
                            <li>Total <span><?php echo '$' . number_format(61, 2); ?></span></li>
                        </ul>
...
<br>
    ...
    <script>
    // JavaScript para actualizar el total con el signo de pesos
    document.addEventListener('DOMContentLoaded', function() {
        const quantityInput = document.querySelector('.cart_quantity_input');
        const price = parseFloat('<?php echo $precio; ?>');  // Usamos PHP para insertar el precio

        document.querySelector('.cart_quantity_up').addEventListener('click', function() {
        ...
        document.querySelector('.cart_quantity_down').addEventListener('click', function() {
            let quantity = parseInt(quantityInput.value);
            if (quantity > 1) {
                quantity--;
                quantityInput.value = quantity;
        ...
        function updateTotal(quantity, price) {
            ...
            document.querySelector('.cart_total_price').textContent = '$' + total.toFixed(2);  // Se agrega el signo de peso
        }
    });
    </script>
</body>
